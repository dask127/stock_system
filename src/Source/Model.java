...
public class Model {
    ...
    public ArrayList<Item> getAllItems() {
        ...
        try (Reader reader = new FileReader("src/Source/prueba.json")) {
    ...
    public void addItem(Item ff, String category) {
        ...
        try (Reader reader = new FileReader("src/Source/prueba.json")) {
            ...
            // me meto adentro de la categoria
            JSONObject jsonCatKey = (JSONObject) jsonCategory.get("cuerdas");
            ...
            try (FileWriter file = new FileWriter("src/Source/prueba.json")) {
    ...
    public JSONObject parseItem(Item ff) {
        ...
        details.put("precio", ff.getPrecio());
    ...
    public Item createItem(JSONObject ff) {
        ...
        int precio = CasterObjToInt(info.get("precio"));
